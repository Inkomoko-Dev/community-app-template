        ...
        ResourceFactoryProvider: function () {
            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                    ...
                    groupGSIMAccountResource: defineResource(apiVer + "/groups/:groupId/gsimaccounts", {
                        groupId: '@groupId', parentGSIMAccountNo: '@parentGSIMAccountNo',
                    ...
                    auditResource: defineResource(apiVer + "/audits/:templateResource", { templateResource: '@templateResource' }, {
                        ...
                        searchAll: { method: 'GET', params: {}, isArray: true }
                    }),
                    ...
                    verifyLoanOnMetropolKenya: defineResource(apiVer + "/CreditBureauConfiguration/verifyLoanOnMetropolKenya/:loanId", { loanId: '@loanId' }, {
                        post: { method: 'POST', params: {} }
                    }),
                    verifyLoanCreditInfoEnhancedOnMetropolKenya: defineResource(apiVer + "/CreditBureauConfiguration/verifyLoanCreditInfoEnhancedOnMetropolKenya/:loanId", { loanId: '@loanId' }, {
                        post: { method: 'POST', params: {} }
                    }),
                    ...
                    disbursementReportsResource: defineResource(apiVer + "/reports/jasper/:id", { id: '@id' }, {
                    ...
                    disbursementReportsApproveResource: defineResource(
                        apiVer + "/reports/jasper/:id/approve",
                        { id: '@id' },
                        {
                            approve: { method: 'POST' }
                        }
                    ),
                    disbursementReportsViewResource: defineResource(
                        apiVer + "/reports/jasper/:id/view",
                        { id: '@id' },
                        {
                            view: { method: 'GET' }
                        }
                    ),
                    runDisbursementReportsResource: defineResource(
                        apiVer + "/reports/jasper/:report_name",
